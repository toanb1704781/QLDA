...
<div class="row">
    ...
    <div class="col-8">
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <h4>Tài khoản</h4>
                <form action="{{route('filterAccount')}}" style="width: 50%" method="get" id="formFilterAccount">
                    <strong>Lọc theo:</strong>
                    <select class="form-control" name="isActive" id="filterValue" onchange="filterAccount()">
                        <option @if ($isActive == 1)
                        selected
                        @endif value="1">Đã kích hoạt</option>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    @foreach ($user as $user)
                            ...
                            <td>
                                <span class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="proDropdown">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#repass{{$user->userID}}">
                                                Cấp lại mật khẩu
                                            </a>
                                        </li>
                                        <li>
                        ...
                        {{-- Modal cấp lại tài khoản --}}
                        <div class="modal fade" id="repass{{$user->userID}}" tabindex="-1" aria-labelledby="exampleModalCenteredScrollableTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Cấp lại mật khẩu</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <form action="{{route('rePass', ['userID' => $user->userID])}}" method="post">
                                        @csrf
                                        @method('put')
                                        <div class="modal-body">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="password" name="password" id="password" placeholder="Nhập mật khẩu mới">
                                            </div>

                                            <div class="form-group">
                                                <label for="re-pass">Nhập lại khẩu mới</label>
                                                <input class="form-control" type="password" name="re-pass" id="re-pass" placeholder="Nhập lại mật khẩu mới">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
