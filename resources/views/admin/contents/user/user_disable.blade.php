        ...
        <div class="row mb-2">
            <nav style="--bs-breadcrumb-divider: '>'; padding-top: 10px;" aria-label="breadcrumb" >
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tài khoản vô hiệu hóa</li>
                </ol>
            </nav>

            <div class="col-sm-6">
                <h2> Quản lý tài khoản</h2>
                <a href="{{route('inactiveUser')}}">Tài khoản chưa kích hoạt</a> <br>
                <a href="{{route('disableUser')}}">Tài khoản vô hiệu hóa</a>
            </div>
            <div class="col-sm-6">
